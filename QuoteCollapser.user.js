...
// @namespace    https://musclegrowth.net/profile/35643-massivemusclemass/
// @version      1.0
    ...
    $(`.${quoteClass}`).each(
        function()
        {
            ...
            if(shouldAppendButton)
            {
                ...
                const buttonObserverConfig = { attributes: true, childList: false, subtree: false, attributeFilter: ['class'] };
